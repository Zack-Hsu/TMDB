import { sortSearchResult } from "@/store/slices/searchMovie"
import { useDispatch } from "react-redux"

export default function DESC() {
    const dispatch = useDispatch()
    return (
        <button type="button" className="btn btn-outline-secondary" onClick={() => { dispatch(sortSearchResult("desc")); window.scrollTo(0, 0) }}>
